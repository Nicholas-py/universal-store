/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0b0de62f3e4e58c2729ce22cac4d5e17)
// Runtime types generated with workerd@1.20260710.1 2026-07-16 nodejs_compat
interface __BaseEnv_Env {
	UNIVERSAL_STORE: DurableObjectNamespace<import("./src/index").UniversalStore>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "UniversalStore";
	}
